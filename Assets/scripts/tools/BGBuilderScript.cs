...
public class BGBuilderScript : MonoBehaviour {
    ...
    {
        blockArray = new GameObject[] {w1h1, w2h1, w2h2, w3h2, w3h3, w4h3};
        ...
        for (int w = 0; w < width; w++)
        {
            for (int h = 0; h < height; h++)
            {
                ...
                if (rand == 0)
                {
                    Vector3 v = new Vector3(.5f+ w + transform.position.x - width / 2f, h + transform.position.y - height / 2f, depth);
                ...
                {
                    Vector3 v = new Vector3(1 + w + transform.position.x - width / 2f, h + transform.position.y - height / 2f, depth);
                    field[w, h] = Instantiate(blockArray[rand]) as GameObject;
                    field[w, h].transform.position = v;
                    field[w, h].transform.parent = transform;
                    idents[w, h] = rand;
                ...
                {
                    Vector3 v = new Vector3(1.5f + w + transform.position.x - width / 2f, +h + transform.position.y - height / 2f, depth);
                    field[w, h] = Instantiate(blockArray[rand]) as GameObject;
                    field[w, h].transform.position = v;
                    field[w, h].transform.parent = transform;
                    idents[w, h] = rand;
                ...
                {
                    Vector3 v = new Vector3(2f + w + transform.position.x - width / 2f, +h + transform.position.y - height / 2f, depth);
                    field[w, h] = Instantiate(blockArray[rand]) as GameObject;
                    field[w, h].transform.position = v;
                    field[w, h].transform.parent = transform;
                    idents[w, h] = rand;
        ...
        if (holeGen != 0)
        {
            for (int w = 0; w < width; w++)
            {
                for (int h = 0; h < height; h++)
                {
                    if (idents[w, h] != -1 && Random.Range(0, holeGen) == 0)
                    {
                        DestroyImmediate(field[w, h]);
                        idents[w, h] = -1;
                    }
